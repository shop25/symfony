 ...
 * @author     Anton Korenskoy <anton[at]korenskoy[dot]ru>
 * @version    $Id: sfMessageSource_MySQLi.class.php 23810 2009-11-12 11:07:44Z Kris.Wallsmith $
 * @package    symfony
 * @subpackage i18n
 */
...
class sfMessageSource_MySQLi extends sfMessageSource_Database
{
  ...
  protected function getLastModified($source)
  {
    ...
    $result = $rs ? @intval(mysqli_fetch_array($rs, MYSQLI_NUM)[0]) : 0;
